...
from jama_rest_client.dal.parsers.json import ItemParser
...
class ItemsAPI(BaseAPI):
    ...
    def __get_item(self, item_id: int) -> Item:
        ...
        return ItemParser.parse(item_dict['data'])
    ...
    def __parse_items_dict(self, items_dict: dict) -> List[Item]:
        return list(map(lambda item_dict: ItemParser.parse(item_dict), items_dict))  