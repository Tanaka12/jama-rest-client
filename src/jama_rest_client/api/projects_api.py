...
from jama_rest_client.dal.parsers.json import ProjectParser
...
class ProjectsAPI(BaseAPI):
    ...
    def __parse_projects_dict(self, projects_dict: dict) -> List[Project]:
        return list(map(lambda project_dict: ProjectParser.parse(project_dict), projects_dict))