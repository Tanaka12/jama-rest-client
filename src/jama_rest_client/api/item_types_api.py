...
from jama_rest_client.dal.parsers.json import ItemTypeParser
...
class ItemTypesAPI(BaseAPI):
    ...
    def __parse_item_types_dict(self, item_types_dict: dict) -> List[ItemType]:
        return list(map(lambda item_type_dict: ItemTypeParser.parse(item_type_dict), item_types_dict)) 