...
setup(name='jama_rest_client',
      ...
      packages=['jama_rest_client',
                ...
                'jama_rest_client.dal.serializers',
                'jama_rest_client.dal.serializers.json',
                'jama_rest_client.http',
                'jama_rest_client.model',
                'jama_rest_client.model.activity',
                'jama_rest_client.model.api_response',
                'jama_rest_client.model.archived',
                'jama_rest_client.model.attachment',
                'jama_rest_client.model.comment',
                ...
                'jama_rest_client.model.page_info',
                'jama_rest_client.model.project',
                'jama_rest_client.model.request',
